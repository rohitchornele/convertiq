          ...
          <div className="max-w-[560px]">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              ...
              <button
                ...
                className="px-7 py-3 rounded-xl bg-accent text-white font-bold hover:opacity-90 hover:-translate-y-[2px] transition-all"
              >
                Get Started
              </button>
              {/* Secondary */}
            ...
            <div className="flex flex-wrap gap-5">
              {['Gmail', 'Google Calendar', 'Secure OAuth', 'AI Powered'].map(
                (item) => (
                  <div
                    key={item}
                    className="flex items-center gap-2 text-sm font-medium text-text2"
                  >
